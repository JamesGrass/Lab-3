...
void port_init(){
    P1SEL0 |= BIT5;// Using ADC for pin 1.3. Please change it if you other pin or other function like PWM/UART etc.
    P1SEL1 |= BIT5;//
}
...
void ConfigureAdc_temp1(){
     ...
     ADCMCTL0 |= ADCSREF_0 | ADCINCH_5;    //External Temperature Sensor (P1.3)
     ADCIE |=ADCIE0;
}
